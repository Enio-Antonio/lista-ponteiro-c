...
//Na operação "a=a>>1" os bits são deslocados em uma posição para a direita, o que é equivalente a dividir por 2, ou seja, no exemplo      a=1010 a operação resultaria em a=0101.
//Na operação "b=b<<1", os bits são deslocados em uma posição para a esquerda, o que é equivalente a multiplicar por 2, ou seja, no exemplo       b=0001, a operação resultaria em b=0010.
